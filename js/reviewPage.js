...
//This code is mine
//Code for Movie 1 in the page list.
document.querySelectorAll(".movie-cell")[0].addEventListener("click", function() {
    console.log("clicked");
...
document.querySelectorAll(".review-cell")[0].addEventListener("click", function(){
if (document.querySelectorAll(".overlay")[0].style.display != "none") {
    selectOverlay[0].style.display="none";
}
...
//Code for Movie 3 in the page list.
document.querySelectorAll(".movie-cell")[2].addEventListener("click", function() {
...
document.querySelectorAll(".review-cell")[2].addEventListener("click", function(){
if (document.querySelectorAll(".overlay")[2].style.display != "none") {
   selectOverlay[2].style.display="none"
}
else {console.log("something went wrong");}
...
document.querySelectorAll(".review-cell")[3].addEventListener("click", function(){
if (document.querySelectorAll(".overlay")[3].style.display != "none") {
   selectOverlay[3].style.display="none"
}
else {console.log("something went wrong");}
...
document.querySelectorAll(".review-cell")[4].addEventListener("click", function(){
if (document.querySelectorAll(".overlay")[4].style.display != "none") {
   selectOverlay[4].style.display="none"
}
else {console.log("something went wrong");}
...
document.querySelectorAll(".review-cell")[5].addEventListener("click", function(){
if (document.querySelectorAll(".overlay")[5].style.display != "none") {
selectOverlay[5].style.display="none"
}
else {console.log("something went wrong");}
...
document.querySelectorAll(".review-cell")[6].addEventListener("click", function(){
if (document.querySelectorAll(".overlay")[6].style.display != "none") {
selectOverlay[6].style.display="none"
}
else {console.log("something went wrong");}
...
document.querySelectorAll(".review-cell")[7].addEventListener("click", function(){
if (document.querySelectorAll(".overlay")[7].style.display != "none") {
selectOverlay[7].style.display="none"
}
else {console.log("something went wrong");}
...
document.querySelectorAll(".review-cell")[8].addEventListener("click", function(){
if (document.querySelectorAll(".overlay")[8].style.display != "none") {
selectOverlay[8].style.display="none"
}
else {console.log("something went wrong");}
...
document.querySelectorAll(".review-cell")[9].addEventListener("click", function(){
if (document.querySelectorAll(".overlay")[9].style.display != "none") {
selectOverlay[9].style.display="none"
}
else {console.log("something went wrong");}
...
document.querySelectorAll(".review-cell")[10].addEventListener("click", function(){
if (document.querySelectorAll(".overlay")[10].style.display != "none") {
selectOverlay[10].style.display="none"
}
else {console.log("something went wrong");}
